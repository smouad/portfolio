        ...
        <div className="flex flex-col gap-y-4 items-center justify-center">
          <div className="flex items-center w-full">
            ...
            <div className="border bg-primary z-10 rounded-xl px-4 py-1">
              <span className="text-background text-sm font-medium">Also built</span>
            </div>
          ...
          <div className="flex flex-col gap-y-3 items-center justify-center">
            ...
            <p className="text-muted-foreground md:text-lg/relaxed lg:text-base/relaxed xl:text-lg/relaxed text-balance text-center">
              Beyond the projects above, I&apos;ve shipped {DATA.hackathons.length}+ more —
              client work, browser extensions, AI tools, and low-level systems written in C.
              A selection of the ones I learned the most from.
            </p>
          </div>
        </div>
        <Timeline>
